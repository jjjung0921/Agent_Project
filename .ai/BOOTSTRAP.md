...
10. `.ai/LOG.md`에서 템플릿 생성 세션 항목을 지우고, `AGENTS.md`의 Session Procedure(종료)대로 끝낸다 (CURRENT.md·HANDOFF.md 갱신, LOG 항목 추가, `scripts/ai-end.sh --set-checkpoint`, close commit).
